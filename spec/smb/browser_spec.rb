    ...
    class Browser
      ...
      describe HostAnnouncement do
        ...
        it '#read a header' do
          ...
          expect(pkt.smb_browser.server_name).to eq('DESKTOP-30HMVIQ'.b)
      ...
      describe DomainAnnouncement do
        ...
        it '#read a header' do
          ...
          expect(pkt.smb_browser.periodicity).to eq(12*60*1_000)
          expect(pkt.smb_browser.machine_group).to eq('WORKGROUP'.b)
      ...
      describe LocalMasterAnnouncement do
        ...
        it '#read a header' do
          ...
          expect(pkt.smb_browser.update_count).to eq(71)
          expect(pkt.smb_browser.periodicity).to eq(12*60*1_000)
          expect(pkt.smb_browser.server_name).to eq('FREEBOX'.b)
